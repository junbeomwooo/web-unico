...
class DBPool { 
    ...
    static connectionInfo = {
        host: process.env.DATABASE_HOST,            // MQSQL 서버 주소 (다른 PC인 경우 IP주소),
        port: process.env.DATABASE_PORT,            // MQSQL 포트번호
        user: process.env.DATABASE_USERNAME,        // MQSQL을 로그인 할 수 있는 계정이름
        ...
        connectTimeout: process.env.DATABASE_CONNECTION_TIMEOUT,            //  대기중 시간초과시 커넥션 타임아웃
